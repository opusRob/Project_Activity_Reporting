...
class TaskTypesControllerTest < ActionController::TestCase
  ...
  test "should create task_type" do
    assert_difference('TaskType.count') do
      post :create, task_type: { deleted_at: @task_type.deleted_at, description: @task_type.description, is_active: @task_type.is_active, is_deleted: @task_type.is_deleted, name: @task_type.name }
    end
  ...
  test "should update task_type" do
    patch :update, id: @task_type, task_type: { deleted_at: @task_type.deleted_at, description: @task_type.description, is_active: @task_type.is_active, is_deleted: @task_type.is_deleted, name: @task_type.name }
    assert_redirected_to task_type_path(assigns(:task_type))
  end
