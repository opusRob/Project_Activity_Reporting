...
class BuildsControllerTest < ActionController::TestCase
  ...
  test "should create build" do
    assert_difference('Build.count') do
      post :create, build: { deleted_at: @build.deleted_at, is_active: @build.is_active, is_deleted: @build.is_deleted, name: @build.name }
    end
  ...
  test "should update build" do
    patch :update, id: @build, build: { deleted_at: @build.deleted_at, is_active: @build.is_active, is_deleted: @build.is_deleted, name: @build.name }
    assert_redirected_to build_path(assigns(:build))
  end
