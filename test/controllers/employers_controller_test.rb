...
class EmployersControllerTest < ActionController::TestCase
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post :create, employer: { deleted_at: @employer.deleted_at, is_active: @employer.is_active, is_deleted: @employer.is_deleted, name: @employer.name }
    end
  ...
  test "should update employer" do
    patch :update, id: @employer, employer: { deleted_at: @employer.deleted_at, is_active: @employer.is_active, is_deleted: @employer.is_deleted, name: @employer.name }
    assert_redirected_to employer_path(assigns(:employer))
  end
